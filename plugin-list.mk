...
plugin:
	@mkdir -p plugins
	@[ ! -e plugins/$(DIR) ] && true || ( echo --- ; echo -e "Plugin folder plugins/$(DIR) already exists and will be overwritten. Press \033[1my\033[0m to proceed or any other key to skip this plugin." ; echo --- ; read -n 1 R; [ "$$R" = "y" ] )
	rm -rf plugins/$(DIR)
